...
with DAG(
    ...
    extra_tasks = [
        ...
        #    },
        #    upstream_task_ids={
        #        'model.dbt.int_customers_per_store',
        #        'model.dbt.int_revenue_by_date',
        #    },
        #),
        #ExtraTask(
        ...
        #    },
        #    upstream_task_ids={
        #        'test.dbt.int_customers_per_store',
        #    },
        #    downstream_task_ids={
        #        'snapshot.dbt.int_customers_per_store_snapshot',
        #    },
        #),
        #ExtraTask(
        #    task_id='test_task_3',
    ...
    tg = DbtTaskGroup(
        ...
        dbt_profile_config=DbtProfileConfig(
            profiles_path=Path('/opt/airflow/dbt/'),
            target='dev',
        ),
